...
const ApplicationInfosPage = () => {
  ...
  const pricingLabel = formatMessage({
    id: "Settings.application.link-pricing",
  });
  const upgradeLabel = formatMessage({
    id: "Settings.application.link-upgrade",
  });
  const strapiVersion = formatMessage({
    id: "Settings.application.strapi-version",
  });
  const nodeVersion = formatMessage({
    id: "Settings.application.node-version",
  });
  const editionTitle = formatMessage({
        ...
        <Padded left right top size="smd">
          <Padded left right top size="xs">
            <Flex justifyContent="space-between">
              ...
              <Detail
                link={{
                  label: "Visit for support",
                  href: "https://voqzi.com/",
                }}
                title={"DEVELOPED BY"}
                content={`Voqzi Media Pvt Ltd.`}
              />
            </Flex>
            {/* <Padded top size="lg">
